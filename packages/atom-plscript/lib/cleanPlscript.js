...
export default function (contents) {
    ...
    const map = [
        ...
        {regex: /\b(str_util|su) *= *make\("Str_util"\);\s+/g, val: ''},
        {regex: /\b(str_util|su|make\("Str_util"\))\./g, val: 'Str_util::'},
        ...
        {regex: /\b(prop_extractor|pe) *= *make\("Prop_extractor"\);\s+/g, val: ''},
        {regex: /\b(prop_extractor|pe|make\("Prop_extractor"\))\./g, val: 'List_util::'},
    ...
    if(!/\bmake\("Loader"\)/g.test(contents)) {
        ...
        warning = `YO FOOL! This file contains instances of 'Loader'. Manual replacements with 'M_loader' are required.`;
    }
